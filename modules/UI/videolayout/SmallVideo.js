...
/**
 * Display mode constant used for Serenity.
 * @type {number}
 * @constant
 */
const DISPLAY_SERENITY = 5;
...
export default class SmallVideo {
    ...
    */
    ...
    selectDisplayMode(input) {
        if (input.serenity) {
            return DISPLAY_SERENITY;
        } else if (!input.tileViewActive && input.isScreenSharing) {
    ...
    updateView() {
        ...
        case DISPLAY_SERENITY:
            displayModeString = 'avatar-serenity';
            this.$container.addClass('display-serenity');
            break;
